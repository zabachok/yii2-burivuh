...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="input-group">        
            <span class="input-group-btn">
                <?= Html::submitButton('&nbsp;<i class="glyphicon glyphicon-hdd"></i>&nbsp;', [
                    'class' => 'btn btn-success',
                    'tabindex' => 3,
                    'id' => 'burivuh-save-butoon',
                    'title' => Yii::t('burivuh', 'Save')
                ]) ?>
            </span>
    ...
    <div>
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-default"
                    onclick="$('#burivuh-link-form').slideUp();$('#burivuh-picture-form').slideToggle();">
            ...
            <div class="input-group">
                ...
                <div class="input-group-btn">
                    <div class="btn btn-primary"
                         onclick="burivuh.write.textFormatting.insertLink()"><?= Yii::t('burivuh', 'Insert') ?></div>
                </div>
            </div>
        </div>
        <div id="burivuh-picture-form" style="display: none;">
            <div class="input-group">
                ...
                <div class="input-group-btn">
                    <div class="btn btn-primary"
                         onclick="burivuh.write.textFormatting.insertPicture()"><?= Yii::t('burivuh', 'Insert') ?></div>
                </div>
            </div>
        </div>
    ...
    <?= Html::activeTextarea($model, 'content', [
        'class' => 'panel-body',
        'style' => 'width:100%;height:800px;font-family: monospace;',
        'id' => 'burivuh-content',
        'tabindex' => 2
    ]) ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <span class="label label-default">Ctrl</span> + <span class="label label-default">s</span>
        - <?= Yii::t('burivuh', 'save document') ?><br>
        <span class="label label-default">Shift</span> + <span class="label label-default">Enter</span>
        - <?= Yii::t('burivuh', 'new line') ?><br>
        <span class="label label-default">Tab</span> - <?= Yii::t('burivuh', 'four spaces') ?><br>
        <b><?= Yii::t('burivuh', 'Text formatting') ?></b><br>

        <span class="label label-default">Ctrl</span> + <span class="label label-default">h</span>
        - <?= Yii::t('burivuh', 'Make this line a header') ?><br>
    </div>
</div>